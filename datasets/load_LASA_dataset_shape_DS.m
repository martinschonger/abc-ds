% Adapted from https://github.com/nbfigueroa/ds-opt/blob/cc62dbc12f47a2360e057423540ae5ead08d8c39/datasets/load_LASA_dataset_shape_DS.m
...
elseif number_model == 0
    ...
    D = load(['datasets/lasahandwritingdataset/DataSet/' name],'demos','dt');
    dt = D.dt;
    demos = D.demos;
    N = length(demos);
    att = [0 0]';
